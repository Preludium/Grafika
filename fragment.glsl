...
void main(void) {
    vec4 kd=texture(textureMap0,iTexCoord0);//mix(texture(textureMap0,iTexCoord0),texture(textureMap1,iTexCoord1),0.25);  //Kolor materia?u dla ?wiat?a  rozpraszanego
